...
#ifndef _GRL_WEBOOB_SOURCE_H_
#define _GRL_WEBOOB_SOURCE_H_
...
typedef struct _GrlWeboobSourcePriv GrlWeboobSourcePriv;

struct _GrlWeboobSource {

  GrlSource parent;
  GrlWeboobSourcePriv *priv;

};

typedef struct _GrlWeboobSourceClass GrlWeboobSourceClass;

struct _GrlWeboobSourceClass {

  GrlSourceClass parent_class;

};

GType grl_weboob_source_get_type (void);

#endif /* _GRL_WEBOOB_SOURCE_H_ */
